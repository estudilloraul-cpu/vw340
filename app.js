...
{time:'08:30–10:40',title:'Piscina, desayuno y recoger',image:'images/lisboa.webp',route:'Lisboa Camping',text:'Mañana sin prisas. Desayuno, un rato de piscina para las niñas, duchas y dejar la furgo completamente recogida porque hoy ya no volvéis al camping.',look:['Bañadores y toallas secos','Tupper preparado','Agua fría para el día','Furgo lista para salir']},
{time:'11:00–11:20',title:'Salida y parking en Alcântara',image:'images/photo-road.jpg',route:'Lisboa Camping → Estacionamento Alcântara · EMEL',text:'Salid a las 11:00 y dejad la T5 en el parking de superficie de Alcântara. La idea es no volver a moverla hasta terminar LX Factory y salir hacia Óbidos.',look:['Guardar ubicación exacta de la furgo','Comprobar que no queda nada visible','Llevar tupper, agua y gorras']},
{time:'11:25–11:40',title:'Bolt hasta Jerónimos',image:'images/real-lisboa.jpg',route:'Parking Alcântara → Mosteiro dos Jerónimos',text:'Pedid un Bolt corto hasta Jerónimos. Os ahorra una caminata poco interesante y empezáis directamente en el extremo de Belém para ir regresando después hacia Alcântara.',look:['Bajar en Praça do Império','Fachada sur del monasterio']},
{time:'11:40–12:25',title:'Mosteiro dos Jerónimos',image:'images/real-lisboa.jpg',route:'Praça do Império → Jerónimos',text:'Prioridad a la arquitectura manuelina. Si la cola del claustro es enorme, no hipotecaría el día: iglesia y exterior ya merecen la parada.',look:['Portada sur','Bóvedas','Motivos marinos y cuerdas de piedra','Tumba de Vasco da Gama']},
{time:'12:25–12:55',title:'Pastéis de Belém',image:'images/real-lisboa.jpg',route:'Jerónimos → Rua de Belém',text:'Café y pastel de nata recién hecho. Probadlo primero solo y después con canela y azúcar. Si queréis, comprad alguno para el camino.',look:['Obrador si se puede ver','Azulejos interiores','Canela + azúcar']},
{time:'13:00–13:25',title:'Padrão dos Descobrimentos',image:'images/real-lisboa.jpg',route:'Jardim da Praça do Império → paseo del Tajo → Padrão',text:'Bajad hacia el río y deteneos en la Rosa dos Ventos. Es más divertido buscar países y rutas en el suelo que limitarse a mirar el monumento.',look:['Rosa dos Ventos','Portugal, Brasil e India','Caras de los navegantes','Puente 25 de Abril al fondo']},
{time:'13:25–13:45',title:'Paseo hasta Torre de Belém',image:'images/real-lisboa.jpg',route:'Padrão → paseo junto al Tajo → Torre de Belém',text:'Un tramo agradable junto al río. No hay necesidad de correr: la Torre se disfruta muy bien desde fuera y hoy no compensa una cola larga para entrar.',look:['Tajo','Monumento a los combatientes','Torre apareciendo al fondo']},
{time:'13:45–14:15',title:'Torre de Belém',image:'images/real-lisboa.jpg',route:'Jardim da Torre de Belém',text:'Rodead el exterior, acercaos al agua y buscad el pequeño rinoceronte esculpido. Haced aquí la foto clásica de Belém.',look:['Rinoceronte de piedra','Garitas','Detalles manuelinos','Reflejo sobre el Tajo']},
{time:'14:15–14:30',title:'Volver hacia Alcântara',image:'images/photo-road.jpg',route:'Torre de Belém → Bolt → parking Alcântara',text:'Con calor y llevando comida, yo volvería en Bolt hasta la zona de la furgo. Recogéis el tupper y camináis al parque para comer con sombra.',look:['Tupper','Agua','Pareo o manta si queréis sentaros en césped']},
{time:'14:40–15:35',title:'Picnic en Tapada das Necessidades',image:'images/real-lisboa.jpg',route:'Parking Alcântara → Tapada / Parque das Necessidades',text:'Comed vuestro tupper en un entorno verde y mucho más tranquilo que la zona turística. Buscad sombra o las mesas de picnic y descansad de verdad antes de LX.',look:['Mesas de picnic','Árboles y sombra','Jardín histórico','Un rato sin prisas']},
{time:'15:35–16:00',title:'Paseo hacia LX Factory',image:'images/photo-road.jpg',route:'Tapada das Necessidades → Alcântara → LX Factory',text:'Bajad de nuevo hacia Alcântara y caminad hasta LX Factory. Si el calor aprieta mucho, recortad el tramo con un Bolt corto.',look:['Puente 25 de Abril cada vez más cerca','Antiguos edificios industriales']},
{time:'16:00–16:15',title:'LX · encontrar la abeja',image:'images/real-lisboa.jpg',route:'Entrada LX Factory → calle principal',text:'Nada más entrar, misión: encontrar la gran abeja de Bordalo II realizada con materiales de desecho. Después mirad paredes, puertas y escaleras: el street art está por todas partes.',look:['Abeja de Bordalo II','Murales','Restos industriales','Grafitis en rincones']},
{time:'16:15–16:40',title:'Ler Devagar',image:'images/real-lisboa.jpg',route:'Calle principal → Ler Devagar',text:'La parada imprescindible de LX. Entrad sin prisa, subid a la planta superior y contemplad el espacio de la antigua imprenta.',look:['Bicicleta suspendida','Estanterías altísimas','Maquinaria de imprenta','Sección infantil','Vista desde arriba']},
{time:'16:40–17:05',title:'Tiendas y diseño',image:'images/real-lisboa.jpg',route:'Ler Devagar → callejones de LX',text:'No entréis en todo. Elegid dos o tres espacios que os llamen: cerámica portuguesa contemporánea, ilustración, láminas, diseño o streetwear.',look:['Cerâmica Factory','Ementa Store','Ilustración local','Objetos que no parezcan souvenir típico']},
{time:'17:05–17:30',title:'Rooftop y despedida de Lisboa',image:'images/real-lisboa.jpg',route:'LX Factory → rooftop / terraza',text:'Si os apetece, terminad con una cerveza o refresco mirando hacia el puente. Es un buen cierre para Lisboa antes de volver a la camper.',look:['Ponte 25 de Abril','Tejados industriales','Foto final de Lisboa']},
{time:'17:30–17:45',title:'Volver a la furgo',image:'images/photo-road.jpg',route:'LX Factory → Estacionamento Alcântara',text:'Son aproximadamente 10–15 minutos andando. Aprovechad para comprar agua o algo de carretera si hace falta.',look:['Revisar ruta a Óbidos','Agua y batería','Todo el mundo al baño antes de salir']},
{time:'17:45–19:00',title:'Lisboa → Óbidos',image:'images/real-obidos.jpg',route:'Alcântara → A8 → Óbidos',text:'Salid de Lisboa directamente hacia Óbidos. Una vez aparcados, no hace falta hacer una visita completa: paseo de tarde, Porta da Vila, Rua Direita y ginjinha si os apetece.',look:['Porta da Vila','Primeras murallas','Luz de última hora','Ginjinha para los adultos']}
];
...
function detailedDayCard(id){if(!['D1','D2'].includes(id))return '';const txt=id==='D1'?'Recorre Lisboa tramo a tramo, con calles, curiosidades y navegación entre cada parada.':'Belém, picnic, LX Factory y salida a Óbidos, paso a paso.';return `<section class="detail-day-entry"><div><small>RUTA PASO A PASO</small><h3>Día al detalle</h3><p>${txt}</p></div><button class="btn detail-day-open" data-detail-day="${id}" data-detail-step="0">Abrir recorrido ›</button></section>`}
